...
<front color="#dd0000">$$平均CPU使用率 = 1 - \frac{空闲时间(idle)_{new} - 空闲时间(idle)_{old}}{总CPU时间_{new} - 总CPU时间_{old}}$$</font>
...
![](http://blog.linyimin.club/images/posts/perf-event.jpg)
...
![perf top数据信息](http://blog.linyimin.club/images/posts/perf-top.png)
...
![两台虚机](http://blog.linyimin.club/images/posts/nginx-bench-virtual-machine.png)
...
![Nginx服务器的性能](http://log.linyimin.club/images/blogs/ngnix-performance-before.png)
...
![](http://blog.linyimin.club/images/posts/Nginx-top-before.png)
...
![](http://blog.linyimin.club/images/posts/perf-info-16.png)
...
![](http://blog.linyimin.club/images/posts/perf-report.png)
...
![](http://blog.linyimin.club/images/posts/nginx-performance-after.png)
